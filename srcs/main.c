...
/*   Updated: 2023/06/15 16:20:01 by blax             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char *argv[])
{
	...
	verif_map(&game);
	if(!is_exitable(&game))
		ft_error_map(&game, "No valid path for exit on this map was found !\n");
	if(!is_collectables(&game))
        ft_error_map(&game, "No valid path for collectibles on this map was found !\n");
	ft_init_mlx(&game);
	charge_images(&game);
	draw_map(&game);
